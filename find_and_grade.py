...
def main() -> None:
    ...
    priority_count = write_priority_leads(PRIORITY_LEADS_OUTPUT_FILE, report_rows)
    ...
    print(f"Created priority_leads.csv with {priority_count} high-opportunity leads.")
